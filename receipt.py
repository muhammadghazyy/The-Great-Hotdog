...
def print_cart(cart, price_data, transaction_id):
...
def print_cart_after_payment(cart, price_data, pay_amount, change, transaction_id):
    ...
    print(f"{'Change':<50} Rp {round(change):,}")
    print("==========================================================================")
